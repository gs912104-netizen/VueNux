...
import { e as createError$1, p as parseQuery, n as hasProtocol, o as joinURL, q as parseURL, f as encodePath, r as decodePath, v as getContext, w as isScriptProtocol, x as withQuery, y as withTrailingSlash, z as withoutTrailingSlash, A as sanitizeStatusCode, $ as $fetch, B as executeAsync, C as defu } from '../_/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DFJs1yFi.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ style: { "font-family": "sans-serif", "max-width": "800px", "margin": "0 auto", "padding": "20px" } }, _attrs))}><header style="${ssrRenderStyle({ "border-bottom": "2px solid #41B883", "padding-bottom": "10px", "margin-bottom": "20px" })}"><h1 style="${ssrRenderStyle({ "color": "#41B883", "margin-bottom": "5px" })}">Nuxt 3 基礎專案演練</h1><nav>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    style: { "margin-right": "15px", "text-decoration": "none", "font-weight": "bold" }
  }, {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode("產品列表")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</nav></header><main style="${ssrRenderStyle({ "background": "#f9f9f9", "padding": "20px", "border-radius": "8px", "min-height": "200px" })}">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CCFldgX_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bx_MlGmf.mjs'));
